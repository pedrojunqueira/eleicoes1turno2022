...
BASE_URL = "https://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/{state}/2022802018/{role_code}/candidatos"
...
for state in states:
    ...
    for role in get_roles:
        ...
        with open(f"./data/{role}_2018/{uf}_{role}.json", "w+") as fp:
