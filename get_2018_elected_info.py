...
BASE_URL = "https://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/buscar/2018/{state}/2022802018/candidato/{candidate_id}"
			...
			for candidate in candidates:
				try:
					...
					if election_outcome in ["Eleito por m\u00e9dia","Eleito por QP"]:
						...
						with open(f"./data/info_2018_winners/{file_name}", "w+") as fp:
